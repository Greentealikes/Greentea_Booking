<?php
/* Smarty version 3.1.34-dev-7, created on 2020-02-05 04:44:22
  from 'D:\xampp\htdocs\php_file\web1\templates\tpl\portfolio.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5e3a3a16993fc2_92532631',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '75679196b452ca7c2eb2e4405a94bf6b5c95bcfc' => 
    array (
      0 => 'D:\\xampp\\htdocs\\php_file\\web1\\templates\\tpl\\portfolio.tpl',
      1 => 1580874224,
      2 => 'file',
    ),
  ),
...
function content_5e3a3a16993fc2_92532631 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<html lang="en">
  ...
  <div class="site-wrap" id="home-section">
    ...
    <header class="site-navbar site-navbar-target" role="banner">
          ...
          <div class="col-9  text-right">
            ...
            <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li class="active">
                    <a href="user.php" id="userin" class="nav-link">Login</a>
                  </li>
                  <li class="active">
                    <a href="logout.php" id="userout" class="nav-link">Logout</a>
                  </li>
            </nav>
          </div>
      ...
      <div class="container booking_container" >
        <div class = "wrap text-left col-12">
          <nav class="site-navigation text-left ml-auto d-none d-lg-block" role="navigation">
            <ul class = "site-menu main-menu js-clone-nav ml-auto">
              <li class="booking_nav nab1"><a href="#"  class="nav-link">
                <b>1</b>
                <stong>選擇日期</stong>
                </a>
              </li>
              <li class="booking_nav nab2"><a href="#"  class="nav-link">
                <b>2</b>
                <stong>訂單填寫</stong>
                </a>
              </li>
              <li class="booking_nav nab3"><a href="#"  class="nav-link">
                <b>3</b>
                <stong>確認訂單</stong>
                </a>
              </li>
             <li class="booking_nav nab4"><a href="#"  class="nav-link">
                <b>4</b>
                <stong>訂單完成</stong>
                </a>
              </li>
