  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-6 mb-5 mb-md-0">
        <img src="<{$xoImgUrl}>images/img_5.jpg" alt="Image" class="img-fluid">
      </div>
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="post-entry-1 h-100">
          <a href="single.html">
            <img src="<{$xoImgUrl}>images/img_1.jpg" alt="Image" class="img-fluid">
          </a>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="post-entry-1 h-100">
          <a href="single.html">
            <img src="<{$xoImgUrl}>images/img_2.jpg" alt="Image" class="img-fluid">
          </a>
          <div class="post-entry-1-contents">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="post-entry-1 h-100">
          <a href="single.html">
            <img src="<{$xoImgUrl}>images/img_3.jpg" alt="Image" class="img-fluid">
          </a>
          <div class="post-entry-1-contents">
