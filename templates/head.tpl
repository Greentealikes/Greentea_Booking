...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">  
        ...
        <header class="site-navbar site-navbar-target" role="banner">
            <div class="container">
                <div class="row align-items-center position-relative">
                    <div class="col-3  ">
                        <div class="site-logo">
                            <a href="index.php" class="font-weight-bold">城苑行旅</a>
                        </div>
                    </div>
                    ...
                    <nav class="text-right xl-auto d-none d-xl-block" role="navigation">
                        <ul class="site-menu main-menu js-clone-nav ml-auto drop-down-menu site-menu-nav">                        
                            <li class="nav_active nav_style ">
                                <a href="about.php?op=about_news">最新消息</a>
                            ...
                            <li class="nav_style">
                                ...
                                <ul class="menu-nav">
                                    <li><a href="services.php?op=room_type">房型介紹</a>
                                    </li>
                                    <li><a href="services.php?op=check_in_info">入住資訊</a>
                                    </li>                                    
                                </ul>
                            </li>
    ...
    <div>
        <img src="<{$xoImgUrl}>images/bg1.jpg">
    </div>
